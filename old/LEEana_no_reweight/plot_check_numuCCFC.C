void plot_check_numuCCFC(int run = 1){
...

  {
    ...
    T_eval->Project("h10","T_KINEvars.kine_reco_Enu","weight_cv*weight_spline*(T_BDTvars.numu_cc_flag>=0 &&match_isFC==1 && (truth_nuEnergy <=400 ) && T_BDTvars.numu_score>0.9 && T_BDTvars.nue_score<=7 && !(T_KINEvars.kine_pio_flag==1 && T_KINEvars.kine_pio_vtx_dis < 9  && T_KINEvars.kine_pio_energy_1 > 40 && T_KINEvars.kine_pio_energy_2 > 25 && T_KINEvars.kine_pio_dis_1 < 110 && T_KINEvars.kine_pio_dis_2 < 120 && T_KINEvars.kine_pio_angle > 0 && T_KINEvars.kine_pio_angle < 174  && T_KINEvars.kine_pio_mass > 22 && T_KINEvars.kine_pio_mass < 300))");
    T_eval->Project("h11","T_KINEvars.kine_reco_Enu","weight_cv*weight_cv*weight_spline*weight_spline*(T_BDTvars.numu_cc_flag>=0 &&match_isFC==1 && (truth_nuEnergy <=400 ) && T_BDTvars.numu_score>0.9 && T_BDTvars.nue_score<= 7 && !(T_KINEvars.kine_pio_flag==1 && T_KINEvars.kine_pio_vtx_dis < 9  && T_KINEvars.kine_pio_energy_1 > 40 && T_KINEvars.kine_pio_energy_2 > 25 && T_KINEvars.kine_pio_dis_1 < 110 && T_KINEvars.kine_pio_dis_2 < 120 && T_KINEvars.kine_pio_angle > 0 && T_KINEvars.kine_pio_angle < 174  && T_KINEvars.kine_pio_mass > 22 && T_KINEvars.kine_pio_mass < 300))");
    h10->Scale(pot_data/(pot_3+pot_4));
    h11->Scale(pow(pot_data/(pot_3+pot_4),2));

    T_eval->Project("h20","T_KINEvars.kine_reco_Enu","weight_cv*weight_spline*(T_BDTvars.numu_cc_flag>=0 && match_isFC==1 && !(truth_nuEnergy <=400 ) && T_BDTvars.numu_score>0.9 && T_BDTvars.nue_score<=7 && !(T_KINEvars.kine_pio_flag==1 && T_KINEvars.kine_pio_vtx_dis < 9  && T_KINEvars.kine_pio_energy_1 > 40 && T_KINEvars.kine_pio_energy_2 > 25 && T_KINEvars.kine_pio_dis_1 < 110 && T_KINEvars.kine_pio_dis_2 < 120 && T_KINEvars.kine_pio_angle > 0 && T_KINEvars.kine_pio_angle < 174  && T_KINEvars.kine_pio_mass > 22 && T_KINEvars.kine_pio_mass < 300))");
    T_eval->Project("h21","T_KINEvars.kine_reco_Enu","weight_cv*weight_cv*weight_spline*weight_spline*(T_BDTvars.numu_cc_flag>=0  &&match_isFC==1 && !(truth_nuEnergy <=400 )&& T_BDTvars.numu_score>0.9 && T_BDTvars.nue_score<=7 && !(T_KINEvars.kine_pio_flag==1 && T_KINEvars.kine_pio_vtx_dis < 9  && T_KINEvars.kine_pio_energy_1 > 40 && T_KINEvars.kine_pio_energy_2 > 25 && T_KINEvars.kine_pio_dis_1 < 110 && T_KINEvars.kine_pio_dis_2 < 120 && T_KINEvars.kine_pio_angle > 0 && T_KINEvars.kine_pio_angle < 174  && T_KINEvars.kine_pio_mass > 22 && T_KINEvars.kine_pio_mass < 300))");
...

  {
    ...
    T_eval->Project("h30","T_KINEvars.kine_reco_Enu","weight_cv*weight_spline*(T_BDTvars.numu_cc_flag>=0 &&match_isFC==1 && (truth_nuEnergy <=400 ) && T_BDTvars.numu_score>0.9 && T_BDTvars.nue_score<=7 && !(T_KINEvars.kine_pio_flag==1 && T_KINEvars.kine_pio_vtx_dis < 9  && T_KINEvars.kine_pio_energy_1 > 40 && T_KINEvars.kine_pio_energy_2 > 25 && T_KINEvars.kine_pio_dis_1 < 110 && T_KINEvars.kine_pio_dis_2 < 120 && T_KINEvars.kine_pio_angle > 0 && T_KINEvars.kine_pio_angle < 174  && T_KINEvars.kine_pio_mass > 22 && T_KINEvars.kine_pio_mass < 300))");
    T_eval->Project("h31","T_KINEvars.kine_reco_Enu","weight_cv*weight_cv*weight_spline*weight_spline*(T_BDTvars.numu_cc_flag>=0 &&match_isFC==1 && (truth_nuEnergy <=400 ) && T_BDTvars.numu_score>0.9 && T_BDTvars.nue_score<= 7 && !(T_KINEvars.kine_pio_flag==1 && T_KINEvars.kine_pio_vtx_dis < 9  && T_KINEvars.kine_pio_energy_1 > 40 && T_KINEvars.kine_pio_energy_2 > 25 && T_KINEvars.kine_pio_dis_1 < 110 && T_KINEvars.kine_pio_dis_2 < 120 && T_KINEvars.kine_pio_angle > 0 && T_KINEvars.kine_pio_angle < 174  && T_KINEvars.kine_pio_mass > 22 && T_KINEvars.kine_pio_mass < 300))");
...

  {
    ...
    T_eval->Project("h40","T_KINEvars.kine_reco_Enu","weight_cv*weight_spline*(T_BDTvars.numu_cc_flag>=0 &&match_isFC==1  && T_BDTvars.numu_score>0.9 && T_BDTvars.nue_score<=7 && !(T_KINEvars.kine_pio_flag==1 && T_KINEvars.kine_pio_vtx_dis < 9  && T_KINEvars.kine_pio_energy_1 > 40 && T_KINEvars.kine_pio_energy_2 > 25 && T_KINEvars.kine_pio_dis_1 < 110 && T_KINEvars.kine_pio_dis_2 < 120 && T_KINEvars.kine_pio_angle > 0 && T_KINEvars.kine_pio_angle < 174  && T_KINEvars.kine_pio_mass > 22 && T_KINEvars.kine_pio_mass < 300))");
    T_eval->Project("h41","T_KINEvars.kine_reco_Enu","weight_cv*weight_cv*weight_spline*weight_spline*(T_BDTvars.numu_cc_flag>=0 &&match_isFC==1 && T_BDTvars.numu_score>0.9 && T_BDTvars.nue_score<= 7 && !(T_KINEvars.kine_pio_flag==1 && T_KINEvars.kine_pio_vtx_dis < 9  && T_KINEvars.kine_pio_energy_1 > 40 && T_KINEvars.kine_pio_energy_2 > 25 && T_KINEvars.kine_pio_dis_1 < 110 && T_KINEvars.kine_pio_dis_2 < 120 && T_KINEvars.kine_pio_angle > 0 && T_KINEvars.kine_pio_angle < 174  && T_KINEvars.kine_pio_mass > 22 && T_KINEvars.kine_pio_mass < 300))");
...

  {
    ...
    T_eval->Project("h50","T_KINEvars.kine_reco_Enu","(T_BDTvars.numu_cc_flag>=0 &&match_isFC==1  && T_BDTvars.numu_score>0.9 && T_BDTvars.nue_score<=7 && !(T_KINEvars.kine_pio_flag==1 && T_KINEvars.kine_pio_vtx_dis < 9  && T_KINEvars.kine_pio_energy_1 > 40 && T_KINEvars.kine_pio_energy_2 > 25 && T_KINEvars.kine_pio_dis_1 < 110 && T_KINEvars.kine_pio_dis_2 < 120 && T_KINEvars.kine_pio_angle > 0 && T_KINEvars.kine_pio_angle < 174  && T_KINEvars.kine_pio_mass > 22 && T_KINEvars.kine_pio_mass < 300))");
    T_eval->Project("h51","T_KINEvars.kine_reco_Enu","(T_BDTvars.numu_cc_flag>=0 &&match_isFC==1 && T_BDTvars.numu_score>0.9 && T_BDTvars.nue_score<= 7 && !(T_KINEvars.kine_pio_flag==1 && T_KINEvars.kine_pio_vtx_dis < 9  && T_KINEvars.kine_pio_energy_1 > 40 && T_KINEvars.kine_pio_energy_2 > 25 && T_KINEvars.kine_pio_dis_1 < 110 && T_KINEvars.kine_pio_dis_2 < 120 && T_KINEvars.kine_pio_angle > 0 && T_KINEvars.kine_pio_angle < 174  && T_KINEvars.kine_pio_mass > 22 && T_KINEvars.kine_pio_mass < 300))");
...

   {
    ...
    T_eval->Project("h60","T_KINEvars.kine_reco_Enu","(T_BDTvars.numu_cc_flag>=0 &&match_isFC==1  && T_BDTvars.numu_score>0.9 && T_BDTvars.nue_score<=7 && !(T_KINEvars.kine_pio_flag==1 && T_KINEvars.kine_pio_vtx_dis < 9  && T_KINEvars.kine_pio_energy_1 > 40 && T_KINEvars.kine_pio_energy_2 > 25 && T_KINEvars.kine_pio_dis_1 < 110 && T_KINEvars.kine_pio_dis_2 < 120 && T_KINEvars.kine_pio_angle > 0 && T_KINEvars.kine_pio_angle < 174  && T_KINEvars.kine_pio_mass > 22 && T_KINEvars.kine_pio_mass < 300))");
    T_eval->Project("h61","T_KINEvars.kine_reco_Enu","(T_BDTvars.numu_cc_flag>=0 &&match_isFC==1 && T_BDTvars.numu_score>0.9 && T_BDTvars.nue_score<= 7 && !(T_KINEvars.kine_pio_flag==1 && T_KINEvars.kine_pio_vtx_dis < 9  && T_KINEvars.kine_pio_energy_1 > 40 && T_KINEvars.kine_pio_energy_2 > 25 && T_KINEvars.kine_pio_dis_1 < 110 && T_KINEvars.kine_pio_dis_2 < 120 && T_KINEvars.kine_pio_angle > 0 && T_KINEvars.kine_pio_angle < 174  && T_KINEvars.kine_pio_mass > 22 && T_KINEvars.kine_pio_mass < 300))");
    //h50->Scale(pot_data/(pot_6));
    //h51->Scale(pow(pot_data/(pot_6),2));
  }
