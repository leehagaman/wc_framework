void plot_eff_CCpi0(){
  ...
  T_eval->Project("h11","truth_pi0Energy","weight_cv*weight_spline*(abs(truth_nuPdg)==14 && truth_isCC==1 && truth_vtxInside==1 && truth_NprimPio>0 && flag_numuCC && flag_cc_pi0 && (!flag_nueCC) && match_isFC==1)");
  T_eval->Project("h12","truth_pi0Energy","weight_cv*weight_spline*(abs(truth_nuPdg)==14 && truth_isCC==1 && truth_vtxInside==1 && truth_NprimPio>0 && flag_numuCC && flag_cc_pi0 && (!flag_nueCC) )");
  ...
  T_eval3->Project("h31","truth_pi0Energy","weight_cv*weight_spline*(abs(truth_nuPdg)==14 && truth_isCC==1 && truth_vtxInside==1 && truth_NprimPio>0 && flag_numuCC && flag_cc_pi0 && (!flag_nueCC) && match_isFC==1)");
  T_eval3->Project("h32","truth_pi0Energy","weight_cv*weight_spline*(abs(truth_nuPdg)==14 && truth_isCC==1 && truth_vtxInside==1 && truth_NprimPio>0 && flag_numuCC && flag_cc_pi0 && (!flag_nueCC) )");
  ...
  // T_eval3->Project("h32","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==14 && truth_isCC==1 && truth_vtxInside==1  && flag_numuCC )");
   ...
   g1->SetTitle("CC#pi^{0} Efficiency");
