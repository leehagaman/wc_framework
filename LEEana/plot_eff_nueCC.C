void plot_eff_nueCC(){
  ...
  TFile *file3 =  new TFile("./processed_checkout_rootfiles/checkout_prodgenie_bnb_intrinsic_nue_overlay_run3.root");
  ...
  T_eval->Project("h11","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1 && T_BDTvars.numu_cc_flag>=0 && T_BDTvars.nue_score>6.5 && match_isFC==1)");
  ...
  // generic neutrino step ...
  // T_eval->Project("h10","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1)");
  // T_eval->Project("h11","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1 && T_BDTvars.numu_cc_flag>=0  && match_isFC==1)");
  // T_eval->Project("h12","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1 && T_BDTvars.numu_cc_flag>=0 )");

  // T_eval3->Project("h30","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1)");
  // T_eval3->Project("h31","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1 && T_BDTvars.numu_cc_flag>=0  && match_isFC==1)");
  // T_eval3->Project("h32","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1 && T_BDTvars.numu_cc_flag>=0  )");
