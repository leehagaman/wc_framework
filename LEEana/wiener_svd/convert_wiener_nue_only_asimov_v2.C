void convert_wiener_nue_only_asimov_v2(){
  gStyle->SetOptStat(0);
  ...
  TH1F *hmc_obsch_1 = (TH1F*)file1->Get("hmc_obsch_1");  // pred FC
  TH1F *hmc_obsch_2 = (TH1F*)file1->Get("hmc_obsch_2"); // pred PC
  TH1F *histo_1 = (TH1F*)file1->Get("histo_1"); // FC mc signal
  TH1F *histo_2 = (TH1F*)file1->Get("histo_2"); // FC mc bkg
  TH1F *histo_3 = (TH1F*)file1->Get("histo_3"); // PC mc signal
  TH1F *histo_4 = (TH1F*)file1->Get("histo_4"); // PC mc bkg
  ...
  Int_t nbin_meas = hmc_obsch_1->GetNbinsX() + 1 + hmc_obsch_2->GetNbinsX() + 1;
  ...
  for (Int_t i=0;i!=hmc_obsch_1->GetNbinsX()+1;i++){
    hmeas->SetBinContent(i+1,hmc_obsch_1->GetBinContent(i+1) - histo_2->GetBinContent(i+1) - histo_5->GetBinContent(i+1) );
    hmeas->SetBinContent(i+1 + hmc_obsch_1->GetNbinsX() + 1 , hmc_obsch_2->GetBinContent(i+1) - histo_4->GetBinContent(i+1) - histo_6->GetBinContent(i+1) );
