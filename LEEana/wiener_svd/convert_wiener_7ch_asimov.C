void convert_wiener_7ch_asimov(){
  gStyle->SetOptStat(0);
  ...
  for (Int_t i=0;i!=26;i++){
    ...
    hmeas->SetBinContent(i+1, hmc_obsch_1->GetBinContent(i+1) - histo_2->GetBinContent(i+1) - histo_15->GetBinContent(i+1) );
    // nueCC PC
    hmeas->SetBinContent(i+1 + 26, hmc_obsch_2->GetBinContent(i+1) - histo_4->GetBinContent(i+1) - histo_16->GetBinContent(i+1) );    
    // numuCC FC
    hmeas->SetBinContent(i+1 + 2*26, hmc_obsch_3->GetBinContent(i+1) - histo_6->GetBinContent(i+1) - histo_17->GetBinContent(i+1) );
    // numuCC PC
    hmeas->SetBinContent(i+1 + 3*26, hmc_obsch_4->GetBinContent(i+1) - histo_8->GetBinContent(i+1) - histo_18->GetBinContent(i+1) );
  ...
  for (Int_t i=0; i!=11; i++){
    ...
    // numuCC Pi0 FC
    hmeas->SetBinContent(i+1 + 4*26, hmc_obsch_5->GetBinContent(i+1) - histo_10->GetBinContent(i+1) - histo_19->GetBinContent(i+1) );
    // numuCC Pi0 PC
    hmeas->SetBinContent(i+1 + 4*26 + 11, hmc_obsch_6->GetBinContent(i+1) - histo_12->GetBinContent(i+1) - histo_20->GetBinContent(i+1) );
    // NC Pi0 PC
    hmeas->SetBinContent(i+1 + 4*26 + 2*11, hmc_obsch_7->GetBinContent(i+1) - histo_14->GetBinContent(i+1) - histo_21->GetBinContent(i+1) );
  ...
  for (Int_t i=0;i!=11;i++){
    double meas = hmc_obsch_5->GetBinContent(i+1);
  ...
  for (Int_t i=0;i!=11;i++){
    double meas = hmc_obsch_6->GetBinContent(i+1);
  ...
  for (Int_t i=0;i!=11;i++){
    double meas = hmc_obsch_7->GetBinContent(i+1);
