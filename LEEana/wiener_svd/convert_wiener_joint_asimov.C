void convert_wiener_joint_asimov(){
  gStyle->SetOptStat(0);
  ...
  Int_t nbin_meas = 4 * (hmc_obsch_1->GetNbinsX() + 1);
  ...
  for (Int_t i=0;i!=hmc_obsch_1->GetNbinsX()+1;i++){
    
    std::cout << "lhagaman debug, i = " << i << "\n";
	  
    // numuCC FC, data - bkg - ext
    hmeas->SetBinContent(i+1, hmc_obsch_1->GetBinContent(i+1) - histo_2->GetBinContent(i+1) - histo_9->GetBinContent(i+1) );
    // numuCC PC
    hmeas->SetBinContent(i+1 + hmc_obsch_1->GetNbinsX() + 1, hmc_obsch_2->GetBinContent(i+1) - histo_4->GetBinContent(i+1) - histo_10->GetBinContent(i+1) );
    // nueCC FC
    hmeas->SetBinContent(i+1 + 2*(hmc_obsch_1->GetNbinsX() + 1), hmc_obsch_3->GetBinContent(i+1) - histo_6->GetBinContent(i+1) - histo_11->GetBinContent(i+1) );
    // nueCC PC
    hmeas->SetBinContent(i+1 + 3*(hmc_obsch_1->GetNbinsX() + 1), hmc_obsch_4->GetBinContent(i+1) - histo_8->GetBinContent(i+1) - histo_12->GetBinContent(i+1) );
    ...
    // numuCC PC
    hpred->SetBinContent(i+1 + hmc_obsch_1->GetNbinsX() + 1, hmc_obsch_2->GetBinContent(i+1) );
    // nueCC FC
    hpred->SetBinContent(i+1 + 2*(hmc_obsch_1->GetNbinsX() + 1), hmc_obsch_3->GetBinContent(i+1) );
    // nueCC PC
    hpred->SetBinContent(i+1 + 3*(hmc_obsch_1->GetNbinsX() + 1), hmc_obsch_4->GetBinContent(i+1) );
  ...
  for (Int_t i=0;i!=hmc_obsch_1->GetNbinsX()+1;i++){
    double meas = hmc_obsch_1->GetBinContent(i+1);
  ...
  for (Int_t i=0;i!=hmc_obsch_2->GetNbinsX()+1;i++){
    double meas = hmc_obsch_2->GetBinContent(i+1);
    ...
    hcov_stat->SetBinContent(hmc_obsch_1->GetNbinsX()+1+i+1,hmc_obsch_1->GetNbinsX()+1+i+1,content);
  }
  for (Int_t i=0;i!=hmc_obsch_3->GetNbinsX()+1;i++){
    double meas = hmc_obsch_3->GetBinContent(i+1);
    ...
    hcov_stat->SetBinContent(2*(hmc_obsch_1->GetNbinsX()+1)+i+1,2*(hmc_obsch_1->GetNbinsX()+1)+i+1,content);
  }
  for (Int_t i=0;i!=hmc_obsch_4->GetNbinsX()+1;i++){
    double meas = hmc_obsch_4->GetBinContent(i+1);
    ...
    hcov_stat->SetBinContent(3*(hmc_obsch_1->GetNbinsX()+1)+i+1,3*(hmc_obsch_1->GetNbinsX()+1)+i+1,content);
  }
  //hcov_stat->Draw("COLZ");
