void plot_eff_nueCCpi0(){
  // TFile *file1 =  new TFile("checkout_prodgenie_bnb_nu_overlay_run1.root");
  TFile *file1 =  new TFile("../../checkout_rootfiles_correct_bdt/checkout_prodgenie_bnb_intrinsic_nue_overlay_run123_all.root");
  ...
  // cout << T_eval->GetEntries("weight_cv*weight_spline*(abs(truth_nuPdg)==14 && truth_isCC==1 && truth_vtxInside==1 && truth_NprimPio>0 && flag_numuCC && flag_cc_pi0 && (!flag_nueCC))") << endl;
  
  // CCpi0 
  T_eval->Project("h10","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1 && truth_NprimPio>0 )");
  T_eval->Project("h11","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1 && truth_NprimPio>0 && flag_nueCC && match_isFC==1)");
  T_eval->Project("h12","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1 && truth_NprimPio>0 && flag_nueCC )");
...
//  T_eval->Project("h11","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1 && truth_NprimPio==0)");
//  T_eval->Project("h12","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1 && truth_NprimPio>0)");
//  
//
//  // reco energy
//  // T_eval->Project("h10","T_KINEvars.kine_reco_Enu","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1 && flag_nueCC)");
//  // T_eval->Project("h11","T_KINEvars.kine_reco_Enu","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1 && truth_NprimPio==0 && flag_nueCC)");
//  // T_eval->Project("h12","T_KINEvars.kine_reco_Enu","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1 && truth_NprimPio>0 && flag_nueCC)");
//
//
//
//  h10->SetTitle("");
//  h10->SetLineColor(1);
//  h10->SetLineWidth(2);
//  h10->GetXaxis()->SetTitle("E^{#nu}_{true} (MeV)");
//  // h10->GetXaxis()->SetTitle("E^{#nu}_{reco} (MeV)");
//  h10->Draw("hist");
//  h11->SetLineColor(4);
//  h11->SetLineWidth(2);
//  h11->Draw("same hist");
...
//  le1->SetBorderSize(0);
//  le1->AddEntry(h10,"Total","lp");
//  le1->AddEntry(h11,"#nu_{e}CC w.o #pi^{0}","lp");
//  le1->AddEntry(h12,"#nu_{e}CC w. #pi^{0}","lp");
//  le1->Draw();
...
//
//  T_eval3->Project("h30","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1 && truth_NprimPio>0)");
//  T_eval3->Project("h31","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1 && truth_NprimPio>0 && flag_nueCC && flag_cc_pi0 && match_isFC==1)");
//  T_eval3->Project("h32","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==12 && truth_isCC==1 && truth_vtxInside==1 && truth_NprimPio>0 && flag_nueCC && flag_cc_pi0 )");
//
//
//  // cross check 1: numuCC
//  // T_eval->Project("h10","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==14 && truth_isCC==1 && truth_vtxInside==1 )");
//  // T_eval->Project("h11","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==14 && truth_isCC==1 && truth_vtxInside==1  && flag_numuCC && match_isFC==1)");
//  // T_eval->Project("h12","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==14 && truth_isCC==1 && truth_vtxInside==1  && flag_numuCC )");
//
//  // T_eval3->Project("h30","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==14 && truth_isCC==1 && truth_vtxInside==1 )");
//  // T_eval3->Project("h31","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==14 && truth_isCC==1 && truth_vtxInside==1  && flag_numuCC && match_isFC==1)");
//  // T_eval3->Project("h32","truth_nuEnergy","weight_cv*weight_spline*(abs(truth_nuPdg)==14 && truth_isCC==1 && truth_vtxInside==1  && flag_numuCC )");
// 
//   
   ...
   g1->SetTitle("#nu_{e} CC#pi^{0} Efficiency");
