...
int main( int argc, char** argv )
{
  ...
  else // flag_breakdown == true
  {
	...
	if (obschannel<=6){
                ...
                gratio_mc[obschannel-1]->GetXaxis()->SetTitle("Reconstructed #pi^{0} Kinetic Energy (MeV)");
	}else if(obschannel<=15){
                gratio_mc[obschannel-1]->GetXaxis()->SetTitle("Reconstructed Neutrino Energy (MeV)");
	}else if(obschannel<=18){
		gratio_mc[obschannel-1]->GetXaxis()->SetTitle("Reconstructed #pi^{0} Kinetic Energy (MeV)");
	}else{
	...
	*/
	...
	/*
	if (obschannel<=1){
                gratio_mc[obschannel-1]->GetXaxis()->SetTitle("Reconstructed Proton-Pi0 Invariant Mass (MeV/c^2)");
        }else if(obschannel<=2){
                gratio_mc[obschannel-1]->GetXaxis()->SetTitle("Reconstructed Proton-Pi0 Total Momentum (MeV/c)");
	}else if(obschannel<=3){
                gratio_mc[obschannel-1]->GetXaxis()->SetTitle("Reconstructed Proton-Pi0 Invariant Mass (MeV/c^2)");
	}else if(obschannel<=4){
                gratio_mc[obschannel-1]->GetXaxis()->SetTitle("Reconstructed Proton-Pi0 Total Momentum (MeV/c)");
