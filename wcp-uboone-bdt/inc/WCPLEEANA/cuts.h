...
namespace LEEana{
  ...
  bool is_glee_1g1p_sel(EvalInfo& info);
  bool is_glee_1g0p_sel(EvalInfo& info);
...
int LEEana::get_cut_pass(TString ch_name_0, TString add_cut, bool flag_data, EvalInfo& eval, PFevalInfo& pfeval, TaggerInfo& tagger, KineInfo& kine){
  ...
  if (ch_name.EndsWith("_dup_8")) ch_name = ch_name.ReplaceAll("_dup_8","");
	...
	bool flag_glee_1g1p_sel = is_glee_1g1p_sel(eval);
	bool flag_glee_1g0p_sel = is_glee_1g0p_sel(eval);
  ...
  // cuts for joint WC/gLEE analysis
    ...
    return false;
  }else if (ch_name == "wc_1g0p" || ch_name == "wc_1g0p_ext" || ch_name == "wc_1g0p_dirt"){
    if (flag_FC && flag_ncdelta_sel && flag_0p) return true;
    return false;
  }else if (ch_name == "wc_1gNp_nc_delta_overlay"){
            if (flag_FC && flag_ncdelta_sel && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)){
                  return true;
	    }
	    return false;
  }else if (ch_name == "wc_1g0p_nc_delta_overlay"){
            if (flag_FC && flag_ncdelta_sel && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)){
                  return true;
	    }
	    return false;
  }else if (ch_name == "wc_1gNp_true_Np_nc_delta_overlay"){
            if (flag_FC && flag_ncdelta_sel && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==0){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "wc_1g0p_true_Np_nc_delta_overlay"){
            if (flag_FC && flag_ncdelta_sel && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==0){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "wc_1gNp_true_0p_nc_delta_overlay"){
            if (flag_FC && flag_ncdelta_sel && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==1){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "wc_1g0p_true_0p_nc_delta_overlay"){
            if (flag_FC && flag_ncdelta_sel && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==1){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "wc_1gNp_nc_pi0_overlay"){
	    if (flag_FC && flag_ncdelta_sel && (!flag_0p)
			    && (eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1
                            && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1))) return true;
                  return false;
  }else if (ch_name == "wc_1g0p_nc_pi0_overlay"){
	    if (flag_FC && flag_ncdelta_sel && flag_0p
			    && (eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1
                            && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1))) return true;
                  return false;
  }else if (ch_name == "wc_1gNp_cc_pi0_overlay"){
	    if (flag_FC && flag_ncdelta_sel && (!flag_0p) 
			    && (eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			) return true;
                  return false; 
  }else if (ch_name == "wc_1g0p_cc_pi0_overlay"){
	    if (flag_FC && flag_ncdelta_sel && flag_0p 
			    && (eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			) return true;
                  return false; 
  }else if (ch_name == "wc_1gNp_nue_overlay"){
	    if (flag_FC && flag_ncdelta_sel && (!flag_0p) 
			    && (eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
                  return false;
  }else if (ch_name == "wc_1g0p_nue_overlay"){
	    if (flag_FC && flag_ncdelta_sel && flag_0p 
			    && (eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
                  return false;
  }else if (ch_name == "wc_1gNp_overlay"){
 	    if (flag_FC && flag_ncdelta_sel && (!flag_0p)
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    && !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    ...
			    && !(eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
	   return false; 
  }else if (ch_name == "wc_1g0p_overlay"){
 	    if (flag_FC && flag_ncdelta_sel && flag_0p
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    && !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    ...
			    && !(eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
	   return false; 
  }else if (ch_name == "wc_1gNp_overlayinFV"){
 	    if (eval.truth_vtxInside==1 && flag_FC && flag_ncdelta_sel && (!flag_0p)
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    && !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    // cutting out run 1 and run 3 CCPi0 only, run 2 CCPi0 should still be included from nu overlay
			    && !(eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
	   return false; 
  }else if (ch_name == "wc_1g0p_overlayinFV"){
 	    if (eval.truth_vtxInside==1 && flag_FC && flag_ncdelta_sel && flag_0p
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    && !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    ...
			    && !(eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
	   return false; 
  }else if (ch_name == "wc_1gNp_overlayoutFV"){
 	    if (eval.truth_vtxInside==0 && flag_FC && flag_ncdelta_sel && (!flag_0p)
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    && !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    // cutting out run 1 and run 3 CCPi0 only, run 2 CCPi0 should still be included from nu overlay
			    && !(eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
	   return false; 
  }else if (ch_name == "wc_1g0p_overlayoutFV"){
 	    if (eval.truth_vtxInside==0 && flag_FC && flag_ncdelta_sel && flag_0p
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    && !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
    ...
    return false;
  }else if (ch_name == "wc_1g0p_presel" || ch_name == "wc_1g0p_presel_ext" || ch_name == "wc_1g0p_presel_dirt"){
    if (flag_FC && flag_ncdelta_presel && flag_0p) return true;
    return false;
  }else if (ch_name == "wc_1gNp_presel_nc_delta_overlay"){
            if (flag_FC && flag_ncdelta_presel && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)){
                  return true;
	    }
	    return false;
  }else if (ch_name == "wc_1g0p_presel_nc_delta_overlay"){
            if (flag_FC && flag_ncdelta_presel && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)){
                  return true;
	    }
	    return false;
  }else if (ch_name == "wc_1gNp_presel_true_Np_nc_delta_overlay"){
            if (flag_FC && flag_ncdelta_presel && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==0){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "wc_1g0p_presel_true_Np_nc_delta_overlay"){
            if (flag_FC && flag_ncdelta_presel && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==0){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "wc_1gNp_presel_true_0p_nc_delta_overlay"){
            if (flag_FC && flag_ncdelta_presel && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==1){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "wc_1g0p_presel_true_0p_nc_delta_overlay"){
            if (flag_FC && flag_ncdelta_presel && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==1){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "wc_1gNp_presel_nc_pi0_overlay"){
	    if (flag_FC && flag_ncdelta_presel && (!flag_0p)
			    && (eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1
                            && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1))) return true;
                  return false;
  }else if (ch_name == "wc_1g0p_presel_nc_pi0_overlay"){
	    if (flag_FC && flag_ncdelta_presel && flag_0p
			    && (eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1
                            && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1))) return true;
                  return false;
  }else if (ch_name == "wc_1gNp_presel_cc_pi0_overlay"){
	    if (flag_FC && flag_ncdelta_presel && (!flag_0p) 
			    && (eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			) return true;
                  return false; 
  }else if (ch_name == "wc_1g0p_presel_cc_pi0_overlay"){
	    if (flag_FC && flag_ncdelta_presel && flag_0p 
			    && (eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			) return true;
                  return false; 
  }else if (ch_name == "wc_1gNp_presel_nue_overlay"){
	    if (flag_FC && flag_ncdelta_presel && (!flag_0p) 
			    && (eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
                  return false;
  }else if (ch_name == "wc_1g0p_presel_nue_overlay"){
	    if (flag_FC && flag_ncdelta_presel && flag_0p 
			    && (eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
                  return false;
  }else if (ch_name == "wc_1gNp_presel_overlay"){
 	    if (flag_FC && flag_ncdelta_presel && (!flag_0p)
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    && !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    ...
			    && !(eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
	   return false; 
  }else if (ch_name == "wc_1g0p_presel_overlay"){
 	    if (flag_FC && flag_ncdelta_presel && flag_0p
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    && !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    ...
			    && !(eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
	   return false; 
  }else if (ch_name == "glee_1g1p_overlayinFV"){
    if (flag_glee_1g1p_sel && eval.truth_vtxInside==1) return true;
    return false;
  }else if (ch_name == "glee_1g1p_overlayoutFV"){
    if (flag_glee_1g1p_sel && eval.truth_vtxInside==0) return true;
    return false;
  }else if (ch_name == "glee_1g0p_overlayinFV"){
    if (flag_glee_1g0p_sel && eval.truth_vtxInside==1) return true;
    return false;
    ...
    return false;
	  ...
	  || ch_name == "glee_1g1p_nue_overlay" || ch_name == "glee_1g1p_overlay"){
    if (flag_glee_1g1p_sel) return true;
    return false;
  }else if (ch_name == "glee_1g0p" || ch_name == "glee_1g0p_ext" || ch_name == "glee_1g0p_dirt"
	  || ch_name == "glee_1g0p_nc_pi0_overlay" || ch_name == "glee_1g0p_cc_pi0_overlay"
	  || ch_name == "glee_1g0p_nue_overlay" || ch_name == "glee_1g0p_overlay"){
    if (flag_glee_1g0p_sel) return true;
    return false;
  }else if (ch_name == "glee_1g1p_nc_delta_overlay"){
            if (flag_glee_1g1p_sel){
                  return true;
	    }
	    return false;
  }else if (ch_name == "glee_1g0p_nc_delta_overlay"){
            if (flag_glee_1g0p_sel){
                  return true;
	    }
	    return false;
  }else if (ch_name == "glee_1g1p_true_Np_nc_delta_overlay"){
            if (flag_glee_1g1p_sel && is_true_0p(pfeval)==0){
                  return true;
	    }
	    return false;
  }else if (ch_name == "glee_1g0p_true_Np_nc_delta_overlay"){
            if (flag_glee_1g0p_sel && is_true_0p(pfeval)==0){
                  return true;
	    }
	    return false;
  }else if (ch_name == "glee_1g1p_true_0p_nc_delta_overlay"){
            if (flag_glee_1g1p_sel && is_true_0p(pfeval)==1){
                  return true;
	    }
	    return false;
  }else if (ch_name == "glee_1g0p_true_0p_nc_delta_overlay"){
            if (flag_glee_1g0p_sel && is_true_0p(pfeval)==1){
                  return true;
	    }
	    return false;
    ...
    return false;
  }else if (ch_name == "constr_nc_pi0_0p" || ch_name == "constr_nc_pi0_0p_ext" || ch_name == "constr_nc_pi0_0p_dirt"){
    if (flag_FC && flag_ncpio_sel && (!flag_ncdelta_sel) && flag_0p) return true;
    return false;
  }else if (ch_name == "constr_nc_pi0_Xp" || ch_name == "constr_nc_pi0_Xp_ext" || ch_name == "constr_nc_pi0_Xp_dirt"){
    if (flag_FC && flag_ncpio_sel && (!flag_ncdelta_sel)) return true;
    return false;
  }else if (ch_name == "constr_nc_pi0_Np_nc_delta_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)){
                  return true;
	    }
	    return false;
  }else if (ch_name == "constr_nc_pi0_0p_nc_delta_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)){
                  return true;
	    }
	    return false;
  }else if (ch_name == "constr_nc_pi0_Xp_nc_delta_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)){
                  return true;
	    }
	    return false;
  }else if (ch_name == "constr_nc_pi0_Np_true_Np_nc_delta_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==0){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "constr_nc_pi0_0p_true_Np_nc_delta_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==0){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "constr_nc_pi0_Np_true_0p_nc_delta_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==1){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "constr_nc_pi0_0p_true_0p_nc_delta_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==1){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "constr_nc_pi0_Np_nc_pi0_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1
                            && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1))) return true;
                  return false;
  }else if (ch_name == "constr_nc_pi0_0p_nc_pi0_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1
                            && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1))) return true;
                  return false;
  }else if (ch_name == "constr_nc_pi0_Xp_nc_pi0_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel)
			    && (eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1
                            && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1))) return true;
                  return false;
  }else if (ch_name == "constr_nc_pi0_Np_cc_pi0_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
				    ) return true;
                  return false; 
  }else if (ch_name == "constr_nc_pi0_0p_cc_pi0_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
				    ) return true;
                  return false; 
  }else if (ch_name == "constr_nc_pi0_Xp_cc_pi0_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel)
			    && (eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
				    ) return true;
                  return false; 
  }else if (ch_name == "constr_nc_pi0_Np_nue_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
                  return false; 
  }else if (ch_name == "constr_nc_pi0_0p_nue_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
                  return false;
  }else if (ch_name == "constr_nc_pi0_Xp_nue_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel)
			    && (eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
                  return false;
  }else if (ch_name == "constr_nc_pi0_Np_overlay"){
	    /*if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && (!flag_0p)){
	    	if (eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1){
			std::cout << "true CCPi0 in nu overlay, NC Pi0 Np selection\n";
			std::cout << "eval.run = " << eval.run << "\n";
		}
	    }*/
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && (!flag_0p)
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    ...
			    && !(eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
	   return false; 
  }else if (ch_name == "constr_nc_pi0_0p_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && flag_0p
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    && !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    ...
			    && !(eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
	   return false; 
  }else if (ch_name == "constr_nc_pi0_Xp_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel)
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    && !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
  ...
  }else if (ch_name == "constr_numuCC_Np" || ch_name == "constr_numuCC_Np_ext" || ch_name == "constr_numuCC_Np_dirt"){
    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && (!flag_0p)) return true;
    return false;
  }else if (ch_name == "constr_numuCC_0p" || ch_name == "constr_numuCC_0p_ext" || ch_name == "constr_numuCC_0p_dirt"){
    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && flag_0p) return true;
    return false;
  }else if (ch_name == "constr_numuCC_Xp" || ch_name == "constr_numuCC_Xp_ext" || ch_name == "constr_numuCC_Xp_dirt"){
    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel)) return true;
    return false;
  }else if (ch_name == "constr_numuCC_Np_nc_delta_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)){
                  return true;
	    }
	    return false;
  }else if (ch_name == "constr_numuCC_0p_nc_delta_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)){
                  return true;
	    }
	    return false;
  }else if (ch_name == "constr_numuCC_Xp_nc_delta_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)){
                  return true;
	    }
	    return false;
  }else if (ch_name == "constr_numuCC_Np_true_Np_nc_delta_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==0){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "constr_numuCC_0p_true_Np_nc_delta_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==0){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "constr_numuCC_Np_true_0p_nc_delta_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==1){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "constr_numuCC_0p_true_0p_nc_delta_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==1){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "constr_numuCC_Np_nc_pi0_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1
                            && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1))) return true;
                  return false;
  }else if (ch_name == "constr_numuCC_0p_nc_pi0_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1
                            && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1))) return true;
                  return false;
  }else if (ch_name == "constr_numuCC_Xp_nc_pi0_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel)
			    && (eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1
                            && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1))) return true;
                  return false;
  }else if (ch_name == "constr_numuCC_Np_cc_pi0_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
				    ) return true;
                  return false; 
  }else if (ch_name == "constr_numuCC_0p_cc_pi0_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
				    ) return true;
                  return false; 
  }else if (ch_name == "constr_numuCC_Xp_cc_pi0_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel)
			    && (eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
				    ) return true;
                  return false; 
  }else if (ch_name == "constr_numuCC_Np_nue_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
                  return false; 
  }else if (ch_name == "constr_numuCC_0p_nue_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
                  return false;
  }else if (ch_name == "constr_numuCC_Xp_nue_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel)
			    && (eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
                  return false;
  }else if (ch_name == "constr_numuCC_Np_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && (!flag_0p)
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    && !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    ...
			    && !(eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
	   return false; 
  }else if (ch_name == "constr_numuCC_0p_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && flag_0p
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    && !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    ...
			    && !(eval.truth_isCC==1 && fabs(eval.truth_nuPdg)==12 && eval.truth_vtxInside==1)) return true;
	   return false; 
  }else if (ch_name == "constr_numuCC_Xp_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel)
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    && !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
  ...
  // start limited overlay channels
  
  }else if (ch_name == "constr_nc_pi0_Np_lim" || ch_name == "constr_nc_pi0_Np_lim_ext" || ch_name == "constr_nc_pi0_Np_lim_dirt"){
    if (flag_FC && flag_ncpio_sel && (!flag_ncdelta_sel) && (!flag_0p)) return true;
    return false;
  }else if (ch_name == "constr_nc_pi0_0p_lim" || ch_name == "constr_nc_pi0_0p_lim_ext" || ch_name == "constr_nc_pi0_0p_lim_dirt"){
    if (flag_FC && flag_ncpio_sel && (!flag_ncdelta_sel) && flag_0p) return true;
    return false;
  }else if (ch_name == "constr_nc_pi0_Xp_lim" || ch_name == "constr_nc_pi0_Xp_lim_ext" || ch_name == "constr_nc_pi0_Xp_lim_dirt"){
    if (flag_FC && flag_ncpio_sel && (!flag_ncdelta_sel)) return true;
    return false;
  }else if (ch_name == "constr_nc_pi0_Np_lim_nc_delta_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)){
                  return true;
	    }
	    return false;
  }else if (ch_name == "constr_nc_pi0_0p_lim_nc_delta_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)){
                  return true;
	    }
	    return false;
  }else if (ch_name == "constr_nc_pi0_Xp_lim_nc_delta_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)){
                  return true;
	    }
	    return false;
  }else if (ch_name == "constr_nc_pi0_Np_lim_true_Np_lim_nc_delta_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==0){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "constr_nc_pi0_0p_lim_true_Np_lim_nc_delta_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==0){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "constr_nc_pi0_Np_lim_true_0p_lim_nc_delta_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==1){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "constr_nc_pi0_0p_lim_true_0p_lim_nc_delta_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==1){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "constr_nc_pi0_Np_lim_nc_pi0_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1
                            && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1))) return true;
                  return false;
  }else if (ch_name == "constr_nc_pi0_0p_lim_nc_pi0_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1
                            && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1))) return true;
                  return false;
  }else if (ch_name == "constr_nc_pi0_Xp_lim_nc_pi0_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel)
			    && (eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1
                            && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1))) return true;
                  return false;
  }else if (ch_name == "constr_nc_pi0_Np_lim_overlay"){
	    /*if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && (!flag_0p)){
	    	if (eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1){
			std::cout << "true CCPi0 in nu overlay, NC Pi0 Np_lim selection\n";
			std::cout << "eval.run = " << eval.run << "\n";
		}
	    }*/
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && (!flag_0p)
	   ...
	   return false; 
  }else if (ch_name == "constr_nc_pi0_0p_lim_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel) && flag_0p
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    //&& !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
	   ...
	   return false; 
  }else if (ch_name == "constr_nc_pi0_Xp_lim_overlay"){
            if (flag_FC && flag_ncpio_sel && !(flag_ncdelta_sel)
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    //&& !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
  ...
  }else if (ch_name == "constr_numuCC_Np_lim" || ch_name == "constr_numuCC_Np_lim_ext" || ch_name == "constr_numuCC_Np_lim_dirt"){
    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && (!flag_0p)) return true;
    return false;
  }else if (ch_name == "constr_numuCC_0p_lim" || ch_name == "constr_numuCC_0p_lim_ext" || ch_name == "constr_numuCC_0p_lim_dirt"){
    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && flag_0p) return true;
    return false;
  }else if (ch_name == "constr_numuCC_Xp_lim" || ch_name == "constr_numuCC_Xp_lim_ext" || ch_name == "constr_numuCC_Xp_lim_dirt"){
    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel)) return true;
    return false;
  }else if (ch_name == "constr_numuCC_Np_lim_nc_delta_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)){
                  return true;
	    }
	    return false;
  }else if (ch_name == "constr_numuCC_0p_lim_nc_delta_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)){
                  return true;
	    }
	    return false;
  }else if (ch_name == "constr_numuCC_Xp_lim_nc_delta_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)){
                  return true;
	    }
	    return false;
  }else if (ch_name == "constr_numuCC_Np_lim_true_Np_lim_nc_delta_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==0){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "constr_numuCC_0p_lim_true_Np_lim_nc_delta_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==0){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "constr_numuCC_Np_lim_true_0p_lim_nc_delta_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==1){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "constr_numuCC_0p_lim_true_0p_lim_nc_delta_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && is_true_0p(pfeval)==1){
                  return true;
	    ...
	    return false;
  }else if (ch_name == "constr_numuCC_Np_lim_nc_pi0_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && (!flag_0p)
			    && (eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1
                            && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1))) return true;
                  return false;
  }else if (ch_name == "constr_numuCC_0p_lim_nc_pi0_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && flag_0p
			    && (eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1
                            && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1))) return true;
                  return false;
  }else if (ch_name == "constr_numuCC_Xp_lim_nc_pi0_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel)
			    && (eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1
                            && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1))) return true;
                  return false;
  }else if (ch_name == "constr_numuCC_Np_lim_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && (!flag_0p)
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    //&& !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
	   ...
	   return false; 
  }else if (ch_name == "constr_numuCC_0p_lim_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel) && flag_0p
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    //&& !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
	   ...
	   return false; 
  }else if (ch_name == "constr_numuCC_Xp_lim_overlay"){
    	    if (flag_FC && flag_numuCC && (!flag_ncpio_sel) && (!flag_ncdelta_sel)
			    && !(eval.truth_isCC==0 && pfeval.truth_NCDelta==1 && eval.truth_vtxInside==1)
			    && !(eval.truth_isCC==0 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
			    //&& !((eval.run < 8317 || eval.run >= 13697) && eval.truth_isCC==1 && eval.truth_nuPdg==14 && eval.truth_vtxInside==1 && pfeval.truth_NprimPio==1)
...
bool LEEana::is_NCdelta_presel(TaggerInfo& tagger_info, PFevalInfo& pfeval){ // includes all cuts except FC
  bool flag = false;
  if (tagger_info.numu_cc_flag >=0 && pfeval.reco_showerKE > 0 && pfeval.reco_showerKE <= 1500) flag = true;
  return flag;
}

// modified this to remove any overflow bin events
