...
void plot_systematics_sub_no_glee()
{  
  //////////////////////////////////////////////////////////////////////////////////////// Draw style
  ...
  std::cout << "read systematics matrix file\n";
  ...
  const int num_ch = 6;
  int bins_ch[num_ch] = {2, 2, 16, 16, 16, 16};
  ...
  //TString pt_str_ch[num_ch] = {"WC 1gNp", "WC 1g0p", "Pandora 1g1p", "Pandora 1g0p", "NC Pi0 Np", "NC Pi0 0p", "numuCC Np", "numuCC 0p"};
  TString pt_str_ch[num_ch] = {"", "", "","", "", ""};
  double pt_str_angle[num_ch] = {90, 90, 25, 25, 25, 25};
  ...
  func_xy_title(h2_basic_stack_flux, "", "Syst. percentage [%]");
  ...
  func_xy_title(h2_basic_stack_geant, "", "Syst. percentage [%]");
  ...
  func_xy_title(h2_basic_stack_detector, "", "Syst. percentage [%]");
  ...
  func_xy_title(h2_basic_stack_total, "", "Syst. percentage [%]");
  ...
  func_xy_title(h1_rel_total, "", "Relative uncertainty");
  ...
  func_xy_title(h1_rel_flux, "", "Relative uncertainty");
  ...
  func_xy_title(h1_rel_detector, "", "Relative uncertainty");
  ...
  func_xy_title(h2_sum_flux_correlation, "", "");
  ...
  func_xy_title(h2_sum_geant_correlation, "", "");
  ...
  func_xy_title(h2_sum_Xs_correlation, "", "");
  ...
  func_xy_title(h2_sum_detector_correlation, "", "");
  ...
  func_xy_title(h2_sum_total_correlation, "", "");
  ...
  TString pt_str_ch_userworld[num_ch*2+1] = {" ", "FC #nu_{#mu}CC",
