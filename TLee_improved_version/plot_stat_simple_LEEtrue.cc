...
void plot_stat_simple_LEEtrue(double exLEE)
{  
  //////////////////////////////////////////////////////////////////////////////////////// Draw style
  ...
  TH1D *h1_pdf_dchi2_LEE2SM = new TH1D("dchi2_LEE2SM", "", 200, -160, 40);
  ...
  h1_pdf_dchi2_LEE2SM->SetLineColor(kBlue);  
  h1_pdf_dchi2_LEE2SM->SetFillColor(kBlue-10); h1_pdf_dchi2_LEE2SM->SetFillStyle(1001);
  ...
  TPaveText *pt_LEE2SM = new TPaveText( x1_LEE2SM + (x2_LEE2SM-x1_LEE2SM)*0.15, y2_LEE2SM*(0.56-0.08),
					x1_LEE2SM + (x2_LEE2SM-x1_LEE2SM)*0.35, y2_LEE2SM*0.88, "l");  
  ...
  pt_LEE2SM->AddText("Test LEEx=1");
  pt_LEE2SM->Draw();

  roostr = "canv_simple2simple_pdf_LEE.png";
